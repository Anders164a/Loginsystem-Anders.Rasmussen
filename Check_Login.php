<html>
  <head>
    ...
    <body>
      ...
      if (($Mit_Brugernavn === $Check_Brugernavn || $Mit_Brugernavn === $Check_Email) && $Mit_Password === $Check_Password) { // Her sikre vi os, at Brugernavnet eller Emailen, hører til det samme password. Så man ikke kan logge ind med en persons brugernavn men en andens password
        if (mysqli_num_rows($resultat) > 0) { // Er der én bruger med det Brugernavn/Email & Password, bliver personen sendt videre. Man kunne også sige at det kun er Email & Password man kan logge ind med, da der er en minimal chance for 2 personer har samme Brugernavn & Password.
